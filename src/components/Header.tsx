      ...
      <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[11px] text-slate-500 leading-none mt-0.5 truncate">
              by Omar Rageh · Full-Stack Developer
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <a
            ...
            className="hidden sm:flex text-xs text-slate-400 hover:text-white border border-slate-700 hover:border-slate-500 rounded-lg px-3 py-2 transition-colors gap-1.5 items-center"
          >
            <svg width={11} height={11} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex text-xs text-[#6fda44] border border-[#6fda44]/30 rounded-lg px-3 py-2 gap-1.5 items-center hover:border-[#6fda44]/60 transition-colors"
          >
